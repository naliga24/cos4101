...
exports.displayReportSummary = function(startDate, endDate, dataReport, res)  {
  'use strict';
  var header = function(rpt, data) {
    ...
    // Report Title
    rpt.newline();
    rpt.print('  รายงานสรุปยอดขายประจำวัน', {fontBold: true, fontSize: 16, align: 'center'});
    rpt.newline();
  ...
  // Detail Header
    ...
    rpt.band([
      ...
      {data: 'ยอดขายสินค้า (บาท)', width: 250, align: 'right'}
    ]);
    rpt.fontNormal();
    rpt.print('_________________________________________________________________________________________________', {align: 'center'});
  };
  ...
  // Detail Body
    ...
    rpt.band([
      ...
      {data: commaNumber(data.TOTAL_PRICE + '.00'), width: 250, align: 'right'}
    ]);
  };
  ...
  var rptName =  "Report Summary.pdf";
